                ...
                <div class="card-body">
                    ...
                    <form method="post" action= "{{route('student.update', ['student' => $student])}}">
                        ...
                        <div class="form-group fs-4">
                            ...
                            <input type="text" id="name" name="name" placeholder=" Please write your name here"class="form-control" value="{{$student->name}}" required>
                        </div>
                        <div class="form-group fs-4">
                            <label for="student_id">Student ID:</label>
                            <input type="text" id="student_id" name="student_id" placeholder=" Please write your student ID here"class="form-control" value="{{$student->student_id}}" required>
                        </div>
                        <div class="form-group fs-4">
